	...
	// const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		{
			...
			items: [
			{ event: "Doors Open & Registration", time: "9:00 AM" },
			{ event: "Opening Ceremony", time: "9:30 AM" },
			{ event: "Hacking Session #1 (Icebreakers + Team Formation + Idea Creation)", time: "10:15 AM" },
			{ event: "Break + Dhuhr Prayer", time: "11:30 AM" },
			{ event: "Hacking Session #2", time: "12:00 PM" },
			{ event: "Break + Asr Prayer + Lunch", time: "2:30 PM" },
			{ event: "Hacking Session #3", time: "3:30 PM" },
			{ event: "Break + Maghrib Prayer", time: "5:30 PM" },
			{ event: "Hacking Session #4", time: "6:15 PM" },
			{ event: "Break + Ishaa Prayer", time: "7:15 PM" },
			{ event: "Hacking Session #5 + Project Submission", time: "7:45 PM" },
