<script lang="ts">
	...
	const eventName = "Brisbane"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "QUT Gardens Point";
	const eventAddress = "2 George Street, Brisbane, QLD 4000, Australia"; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=recofLAm7EG3zrCID"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = "https://maps.app.goo.gl/PkM4oPkMAcmExE7c7"
	const contactLink = "mailto:digitalsolutionsclub@hotmail.com"
	
	// Sponsors Configuration - disable this if you don't have any sponsors to display!
	const sponsorsEnabled = true; // Set to false to hide the entire sponsors section
	const sponsors = [
		{ image: "/brisbane/officeworks.jpg", name: "Officeworks", url: "https://www.officeworks.com.au/" },
	];
	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		{
			...
			items: [
				...
				{ event: "Afternoon Tea", time: "4:00 PM" },
				{ event: "Finished for the Day", time: "6:30 PM" },
			]
		},
		{
			...
			items: [
				{ event: "Doors open", time: "8:00 AM" },
				{ event: "Start working on your project!", time: "8:15 AM" },
				{ event: "Lunch", time: "12:30 PM" },
				{ event: "Finished for the Day", time: "4:15 PM" },
				{ event: "Afternoon Tea", time: "4:30 PM" },
				{ event: "Voting", time: "4:35 PM" },
