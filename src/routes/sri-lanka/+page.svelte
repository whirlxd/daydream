<script lang="ts">
	...
	const eventAddress = "Auditorium, Mathematics Building, Resource Center, Anuradhapura"; // Leave this empty if you don't want an address
	// These two are optional
	const directionsURL = ""
	const contactLink = "mailto:sri-lanka@daydream.hackclub.com"
