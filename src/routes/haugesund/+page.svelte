<script lang="ts">
	...
	const eventName = "Haugesund"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Haugesund";
const eventAddress = "Stedet er ikke bestemt"; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=recYU3uvj3iUIaRFY"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = ""
	const contactLink = "mailto:haugesund@daydream.hackclub.com"
	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		{
			title: "Lørdag, 27. September",
			items: [
        { event: "Dørene åpner", time: "11:00 AM" },
        { event: "Åpningsseremoni", time: "12:00 PM" },
        { event: "Lunsj", time: "12:30 PM" },
        { event: "Begynn å arbeide på prosjektet ditt!", time: "1:00 PM" },
				{ event: "Workshop 1", time: "2:00 PM" },
        { event: "Aktivitet 1", time: "4:00 PM" },
				{ event: "Workshop 2", time: "4:00 PM" },
        { event: "Middag", time: "6:00 PM" },
        { event: "Lyntaler", time: "8:00 PM" },
        { event: "Midnattsoverraskelse", time: "12:00 AM" }
			]
		},
		{
      title: "Søndag, 28. September",
			items: [
        { event: "Frokost", time: "8:00 AM" },
        { event: "Demoer!", time: "10:30 AM" },
        { event: "Avslutningsseremoni", time: "12:00 PM" }
			]
		}
	];
...
<div class="flex flex-col items-center justify-center h-screen text-center bg-gradient-to-b from-[#CCF4FD] to-[#B8D9F8] bg-blend-overlay relative">
	...
	<div class="hero-ui-parallax flex flex-col items-center justify-center text-center relative z-5 -translate-y-2">
		...
		<div class="relative inline-block px-4">
			...
			>
				Organiset av ungdommer i {@html eventLocation.replaceAll(" ", "&nbsp;")}
			</h4>
		</div>
	...
	<div class="relative max-w-4xl mx-auto h-full flex items-start pt-24 max-sm:pt-40 px-8 max-sm:px-2">
		<div class="relative z-20 px-20 pt-20 pb-52 rounded-lg mb-0 max-sm:px-18" style="background-image: url('/letter-top.png'), linear-gradient(to bottom, #FCEFC5 100px, transparent 100px), url('/letter-loop.png'); background-size: 100% auto, 100% auto, 100% auto; background-repeat: no-repeat, no-repeat, repeat-y; background-position: top, top, top; background-attachment: local, local, local;">
			...
			<h2 class="text-5xl font-serif italic text-[#8B4513] mb-10 relative">
				Kjære hackere, musikere og kunstnere,
			...
			<div class="text-[#8B4513] font-serif text-xl leading-relaxed space-y-8">
				<p>Velkommen til Hack Clubs nyeste eventyr. I høst inviterer vi deg til å bli med på Daydream – verdens største Game Jam, som skjer samtidig i 100 byer.</p>

				<p class="font-bold text-2xl">Hack Club vil at du skal lage et spill i høst.</p>

				<p>Ser du ikke på deg selv som en spillutvikler? Null stress – vi har massevis av workshops, både på nett og fysisk, som hjelper deg med å lage ditt aller første spill!</p>

				<p>Denne høsten inviterer vi deg til å lære noe nytt, skape noe du virkelig er stolt av, møte nye venner og dra på et fantastisk eventyr sammen.</p>

				<p class="mb-2">Vi sees,</p>

				<p class="italic text-2xl opacity-85">Augie og Renran fra Hack Club HQ</p>
			</div>
		</div>
	</div>
...
<div class="flex flex-row flex-wrap w-full h-auto bg-gradient-to-b from-[#FCEFC5] to-[#FEC1CF] px-36 max-md:px-8 pb-50 max-sm:pb-24 relative" id="islands-container">
	...
	<div class="flex flex-col items-center w-max basis-1/2 max-md:basis-full max-md:w-full z-10">
		<div class="relative translate-y-8 max-md:translate-y-4 z-30">
          ...
          <span class="font-sans text-[#E472AB] font-bold text-[1.3rem] mr-1">#1:</span> <a href={signupLink} class="underline">Meld deg på</a> Daydream {eventName}
				</div>
			</div>
		</div>
	...
	<div class="flex flex-col items-center w-max basis-1/2 max-md:basis-full max-md:w-full translate-y-24 max-md:translate-y-8 z-10">
		<div class="relative translate-y-24 max-md:translate-y-4 z-30">
			...
			<div class="relative w-72 h-40 max-md:w-80 animate-hover ![--hover:-0.15rem] ![animation-delay:0.3s] z-20" data-point="2">
				...
				<div class="absolute inset-0 justify-center text-center p-6 text-xl font-serif max-md:text-lg text-[#8B4513] inline-block content-center">
					<span class="font-sans text-[#639DEB] font-bold text-[1.3rem] mr-1">#2:</span> Delta på en workshop og lær om spillutvikling
				</div>
			</div>
		</div>
	...
	<div class="flex flex-col items-center w-max basis-1/2 max-md:basis-full max-md:w-full -translate-x-12 max-md:translate-x-0 max-md:translate-y-8 z-10">
		<div class="relative translate-y-8 max-md:translate-y-4 z-30">
			...
			<div class="relative w-72 h-40 max-md:w-80 animate-hover ![--hover:-0.15rem] ![animation-delay:1.4s] z-20" data-point="3">
				...
				<div class="absolute inset-0 justify-center text-center p-6 text-xl font-serif max-md:text-lg text-[#8B4513] inline-block content-center">
          <span class="font-sans text-[#AB68E2] font-bold text-[1.3rem] mr-1">#3:</span> Finn et lag med andre ungdommer på eventet
				</div>
			</div>
		</div>
		...
		<div class="relative translate-y-24 max-md:translate-y-4 z-30">
			...
			<div class="relative w-72 h-40 max-md:w-80 animate-hover ![--hover:-0.15rem] ![animation-delay:2.3s] z-20" data-point="4">
				...
				<div class="absolute inset-0 justify-center text-center p-6 text-xl font-serif max-md:text-lg text-[#8B4513] inline-block content-center">
          <span class="font-sans text-[#F2993E] font-bold text-[1.3rem] mr-1">#4:</span> Begynn å bygge spillet ditt – <em>du trenger ingen erfaring</em>
				</div>
			</div>
		</div>
	...
	<div class="flex flex-col items-center w-full basis-full translate-y-40 max-md:translate-y-12 z-20">
		<div class="relative">
			<div class="bg-[url('/card-final.png')] bg-contain bg-no-repeat bg-center text-2xl font-serif pt-24 px-8 w-128 h-96 text-center max-md:w-80 max-md:h-80 max-md:text-xl max-md:pt-16 animate-hover ![--hover:-0.15rem] ![animation-delay:1.9s]" data-point="5">
				<span class="font-sans text-[#F2CC32] font-bold text-[1.5rem] mr-1">#5:</span> Del det du har laget med verden!
			</div>
		</div>
	</div>
		...
		<div class="relative w-full min-w-72">
			...
			{#if eventAddress}
				<p class="text-center font-sans text-2xl pt-12 max-sm:text-xl text-[#60574b] z-10000">
					{#if directionsURL}
            Daydream {eventName} holdes på <a class="underline text-pink" href={directionsURL}>{eventAddress}</a>!
					{:else}
            Daydream {eventName} holdes på <span class="underline">{eventAddress}</span>!
					{/if}
				</p>
			{/if}
		</div>
	...
	<div class="grid grid-cols-2 gap-8 max-w-6xl px-8 z-10 max-[900px]:grid-cols-1 max-md:gap-16">
		...
		<div class="relative transform -rotate-2">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Hvem kan delta på Daydream?</h3>
				<p class="text-sm">Alle ungdommer i videregående skole og ungdomstrinnet er hjertelig velkomne! Arrangementet er laget for deg som er mellom 13 og 18 år – enten du har laget spill før eller bare er nysgjerrig på å prøve.</p>
		</div>
		</div>
		...
		<div class="relative transform rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Kan jeg arrangere Daydream i min by?</h3>
				<p class="text-sm">Definitivt! Ta kontakt med oss på daydream@hackclub.com eller bli med i kanalen #daydream på Slack for å komme i gang.</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-2">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24  opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Alt dette, helt gratis?</h3>
				<p class="text-sm">Jepp! Mat, swag og god stemning er inkludert. Og hvis du kommer langveisfra, dekker vi kostnaden for bensin eller buss-/togbillett.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			...
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24  opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Hva trenger jeg?</h3>
				<p class="text-sm">Laptopen din, ladere, toalettsaker, sovepose, og godt humør!</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			<img src="window-4.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-1 max-md:text-base">Hva har Hack Club gjort før?</h3>
				<p class="text-sm">Hack Club har arrangert hackathon på GitHub sitt hovedkontor, en Game Jam i 50 byer, og til og med et hackathon på et tog fra Vermont til Los Angeles, og mye mer!</p>
			</div>
		</div>
		...
		<div class="relative transform rotate-1">
			<img src="window-3.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Jeg er ikke god på koding – kan jeg fortsatt være med?</h3>
				<p class="text-sm">Selvfølgelig! Denne game jammen er for alle nivåer. Vi har workshops og aktiviteter gjennom hele helgen, så bli med og lær sammen med oss!</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-2">
			<img src="window-2.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Hva hvis foreldrene mine er bekymret?</h3>
				<p class="text-sm">Vi er her for å hjelpe! Foreldre kan lese vår egen foreldreguide, eller ta kontakt med oss direkte. For generelle spørsmål, send en e-post til daydream@hackclub.com. For spørsmål som gjelder Daydream Haugesund spesielt, kan de kontakte oss på haugesund@daydream.hackclub.com.</p>
			</div>
		</div>
		...
		<div class="relative transform -rotate-1">
			<img src="window-1.png" alt="window" class="w-full h-full object-contain max-md:scale-130 max-xl:scale-110 max-lg:scale-115">
			<div class="absolute top-20 left-12 right-12 bottom-16 flex flex-col items-center justify-center text-center px-24 opacity-70 max-[900px]:mx-[15vw] max-sm:mx-0 max-sm:px-5 max-lg:px-14 max-xl:px-18">
				<h3 class="text-xl font-serif font-bold mb-4 max-lg:mb-0 max-md:text-base">Hva kan jeg lage på Daydream?</h3>
				<p class="text-sm">Hva du vil! Så lenge det passer med temaet, kan du lage hvilken som helst type spill. Plattformspill, partyspill, simulatorer, klikkespill, eller noe helt annet. Vær så kreativ du bare kan!</p>
			</div>
		</div>
	</div>
