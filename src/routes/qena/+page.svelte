<script lang="ts">
	...
	const eventName = "Qena"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Qena City";
	const eventAddress = "مبنى المركزية الجديد لجامعة جنوب الوادى, Masaken Othman Rd, Qena, Qena Governorate 1464041"; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=rec8Dfr7ZZRMVkSJi"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = "https://maps.app.goo.gl/mAMQRa7ENx7iGz1k9"
	const contactLink = "mailto:qena@daydream.hackclub.com"
	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		{
			...
			items: [
				...
				{ event: "Opening session", time: "10:00 PM" },
				{ event: "Ice breaker", time: "10:30 PM" },
				{ event: "Workshop 1", time: "11:00 PM" },
				{ event: "Activity 1", time: "12:00 PM" },
				{ event: "Al-Goma", time: "1:00 PM" },
				{ event: "Lunch", time: "1:40 PM" },
				{ event: "Workshop 2", time: "2:30 PM" },
                { event: "Activity 2", time: "6:00 PM" },
                { event: "Day 1 Ends", time: "9:00 PM" },
		...
		},
		{
			...
			items: [
				{ event: "Doors open", time: "9:00 AM" },
				{ event: "Workshop 1", time: "9:30 PM" },
				{ event: "Lunch", time: "1:30 PM" },
				{ event: "Activity 1", time: "2:00 PM" },
                { event: "Projects demo", time: "6:00 PM" },
				{ event: "Awards distribution", time: "7:00 PM" },
                { event: "Game Jam Ends", time: "9:00 PM" },
