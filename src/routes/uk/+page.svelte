<script lang="ts">
	...
	const eventName = "UK"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Brighton, Cambridge, Cardiff, London, and Manchester";
