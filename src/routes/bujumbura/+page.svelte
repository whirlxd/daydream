<script lang="ts">
	...
	const eventName = "Bujumbura"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Bujumbura City";
	const eventAddress = ""; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=recEBPSxW42W3MPQh"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		{
			...
			items: [
				...
				{ event: "Opening ceremony + Icebreaker", time: "9:00 AM" },
				{ event: "Workshop 1", time: "10:00 AM" },
				{ event: "Team Formation & Start working on project!", time: "10:40 AM" },
				{ event: "Lunch", time: "12:00 PM" },
				{ event: "Workshop 2", time: "2:00 PM" },
				{ event: "Continue working on Project", time: "2:40 PM" },
				{ event: "Fun Break", time: "4:00 PM" },
				{ event: "Dinner + Lightning talks", time: "6:00 PM" },
				{ event: "Wrap for the day", time: "7:00 PM" },
			]
		},
		{
			title: "Sunday, September 28th",
			items: [
				{ event: "Breakfast + checkin", time: "8:00 AM" },
				{ event: "Continue Working On Project", time: "9:00 AM" },
				{ event: "Fun Break", time: "11:00 AM" },
				{ event: "Lunch", time: "12:00 PM" },
				{ event: "Final Hacking Sprint", time: "2:00 PM" },
				{ event: "Project Demos!", time: "3:00 PM" },
				{ event: "Closing ceremony & Award", time: "5:00 PM" },
				{ event: "Networking + Photo session", time: "6:00 PM" },
				{ event: "Event end!", time: "6:30 PM" }
			]
		}
	];
