	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		...
		},
		{
			...
			items: [
				...
				{ event: "Lunch", time: "12:00 PM" },
				{ event: "Deployment & Submission Workshop", time: "1:30 PM" },
				{ event: "Submission starts", time: "2:00 PM" },
				{ event: "Voting starts", time: "3:00 PM" },
				{ event: "Voting ends", time: "3:30 PM" },
				{ event: "Snack time", time: "3:45 PM" },
				{ event: "Winners announced & SWAG distribution", time: "4:00 PM" },
				{ event: "Closing statements", time: "4:15 PM" },
				{ event: "Doors close", time: "4:45 PM" },
			]
		}
	];
