<script lang="ts">
	...
	const eventName = "Gahanga"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Gahanga City";
	const eventAddress = ""; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up?event=rec0sDUzGD4dLnJMa"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
  ...
  items: [
    { event: "Check-in", time: "7:00 AM" },
    { event: "Breakfast", time: "8:00 AM" },
    { event: "Event Start + Opening Ceremony + Team Formation", time: "9:00 AM" },
    { event: "Start Working on Project", time: "10:00 AM" },
    { event: "Workshop 1", time: "11:40 AM" },
    { event: "Lunch", time: "12:00 PM" },
    { event: "Workshop 2", time: "2:00 PM" },
    { event: "Continue Working on Project", time: "2:40 PM" },
    { event: "Relaxation and Break", time: "4:00 PM" },
    { event: "Continue Working on Project", time: "4:20 PM" },
    { event: "Dinner + Networking", time: "6:30 PM" },
...
},
{
  ...
  items: [
    { event: "Doors Open + Check-in", time: "7:00 AM" },
    { event: "Breakfast", time: "8:00 AM" },
    { event: "Continue Working on Project", time: "9:00 AM" },
    { event: "Lunch + Break", time: "11:00 AM" },
    { event: "Finalizing Project", time: "2:00 PM" },
    { event: "Project Demos", time: "3:00 PM" },
    { event: "Closing Ceremony & Awards", time: "6:00 PM" },
    { event: "Networking and Photos", time: "7:00 PM" },
    { event: "Event Close", time: "8:00 PM" }
  ]
}
	];
