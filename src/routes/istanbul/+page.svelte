<script lang="ts">
	...
	const eventName = "İstanbul"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Tech İstanbul, Turkey";
	...
	const languages = {
		tr: {
			title: "Daydream İstanbul - Oyun Jam",
			description: "İstanbul'da Daydream'e katılın! Lise öğrencileriyle birlikte harika oyunlar yaratacağınız, gençler tarafından yönetilen bir oyun jam. Yemek, workshop'lar ve ödüller dahil!",
			keywords: "oyun jam, hackathon, genç kodlama, Hack Club, oyun geliştirme, İstanbul",
			hero: {
				title: "İstanbul'da Oyun Yaratın",
		...
		en: {
			title: "Daydream İstanbul - Game Jam",
			description: "Join Daydream in İstanbul! A teen-led game jam where you'll build amazing games with other high schoolers. Food, workshops, and prizes included!",
			keywords: "game jam, hackathon, teen coding, Hack Club, game development, İstanbul",
			hero: {
				title: "Create Games in İstanbul",
