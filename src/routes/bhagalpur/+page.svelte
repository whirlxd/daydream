<script lang="ts">
	...
	const eventName = "Bhagalpur"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Bhagalpur";
	const eventAddress = ""; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up"; // Get your custom sign up link from this page: https://airtable.com/apppg7RHZv6feM66l/shr4kFqURo8fMIRie
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = ""
	const contactLink = "mailto:bhagalpur@daydream.hackclub.com"
		...
		<div class="relative bg-[#f0f9ff] border-[10px] border-b-[16px] border-[#888896] rounded-lg rounded-b-xl mx-auto z-40">
			...
			<div class="relative bg-gradient-to-b from-[#CCF4FD] to-[#AECDF6] px-8 pt-8 pb-16">
				...
				<div class="relative z-10 min-h-40">
					...
					<p class="text-center">Big shoutout to <a href="https://www.jukeboxprint.com/" class="text-pink underline">Jukebox</a> for our custom stickers!</p>
