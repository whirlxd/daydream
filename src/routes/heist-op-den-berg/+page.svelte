<script lang="ts">
	...
	const eventName = "Heists hackaton"; // This should be the name of your event WITHOUT "Daydream" at the start
	const eventLocation = "Heist-Op-Den-Berg";
	const eventAddress = "Heideheem 15 2221 Heist-Op-Den-Berg Belgium"; // Leave this empty if you don't want an address
	const signupLink = "https://forms.hackclub.com/daydream-sign-up"; // Get your custom sign up link from this page: https://forms.hackclub.com/daydream-sign-up?event=recwpnPAJ1jdJwyLH
	// These two are optional-- leave them empty if you don't have anything!
	const directionsURL = ""
	const contactLink = "mailto:kobegeens@proton.me"
	...
	const scheduleData: { title: string; items: { event: string; time: string; }[] }[] = [
		{
			title: "Zaterdag, 27 September",
			items: [
				{ event: "Deuren open", time: "11:00 AM" },
				{ event: "Middageten", time: "12:30 PM" },
				{ event: "Beginnen aan projecten", time: "1:00 PM" },
				{ event: "Avondeten", time: "6:00 PM" },
			]
		},
		{
			title: "Sunday, September 28th",
			items: [
				{ event: "Ontbijt", time: "8:00 AM" },
				{ event: "Demos!", time: "10:30 AM" },
				{ event: "Afscheid", time: "12:00 PM" }
			]
		}
	];
