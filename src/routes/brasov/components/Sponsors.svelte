					...
					<div class="relative z-10 min-h-40">
						...
						{#if contactLink}
							...
							<div class="mt-8 text-center">
								<p class="text-lg text-[#335969]">Doriți să sponsorizați Daydream {eventName}? <a href={contactLink}
																																																	class="underline hover:text-[#477783] transition-colors">Contactați-ne</a>
								</p>
							</div>
						{/if}
					</div>
