<script lang="ts">
	...
	const languages: Record<'id' | 'en', Record<string, string>> = {
		id: {
			title: 'Daydream Jakarta - Game Jam untuk Siswa SMA',
			description:
				'Bergabunglah dengan Daydream di Jakarta! Game jam yang dipimpin remaja di mana kamu akan membuat game luar biasa bersama siswa SMA lainnya. Makanan, workshop, dan hadiah termasuk!',
			keywords:
